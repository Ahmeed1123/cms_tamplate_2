document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelectorAll(".custom-navbar-nav .custom-nav-item")
    .forEach(function (item) {
      item.addEventListener("click", function () {
        ...
        var target = this.querySelector(".custom-nav-link")
          .getAttribute("href")
          .substr(1);
...
// إضافة معالج الحدث لكل زرارdocument.addEventListener("DOMContentLoaded", function() {
//...
...
const buttons = document.querySelectorAll(".toggle-button-profil");
const contents = document.querySelectorAll(".toggle-content-profil");
// ��ضافة معالج الحد�� لكل ��رار
buttons.forEach((button, index) => {
  button.addEventListener("click", () => {
    // ��زالة النشا�� من ��ميع الأزرار والمحتوى
    ...
    // ��ضافة النشا�� للزرار والمحتوى المنا��بين
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    // تغيير نص ��ر "تسجيل الدخول" ��لى "تسجيل الخروج"
    loginButton.textContent = "تسجيل الخروج";
    loginButton.classList.add("logged-in"); // ��ضافة السمة لتغيير لون الزر
    // ����هار ��ر الصفحة الشخصية بعد تسجيل الدخول
  ...
  loginButton.addEventListener("click", function () {
    if (loginButton.textContent === "تسجيل الخروج") {
      // ��عادة تعيين الزر ��لى "تسجيل الدخول" عند النقر عليه
      loginButton.textContent = "تسجيل الدخول";
      loginButton.classList.remove("logged-in"); // ��زالة السمة للعودة ��لى لون الزر الأصلي
      // ��خفا�� ��ر الصفحة الشخصية بعد تسجيل الخروج
  ...
  profileButton.addEventListener("click", function () {
    // افتح الصفحة الر��يسية
    window.location.href = "الصفحة الر��يسية"; // قم بتغيير هذا الرابط برابط الصفحة الر��يسية الفعلي
  });
});
